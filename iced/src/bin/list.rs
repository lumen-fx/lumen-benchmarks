//! Bench list app - iced 0.13 variant. See repo README for the shared
//! spec (header + 10k-row list + footer).
//!
...
use bench_iced::{bounce, parse_mode, print_deltas_done, print_first_frame,
